...
#' @importFrom stats lm
#' @importFrom tidyr drop_na unnest unnest_wider nest separate
...
utils::globalVariables(c(
  ...
  "temp", "tempC", "water",
  # diff_flux_func.R and ebul_flux_func.R variables
  "concentration_raw", "time_diff", "gruppering", "min_grp", "model", "r2",
  "slope", "n_obs_included_in_lm", "id", "Series", "f0", "f0.up95", "Method",
  "f0.se", "f0.p", "f0.lo95", "method", "hmr_slope",
  "PumpCycle_Timediff", "PumpCycle_Timediff_hr", "top_concentration",
  "min_concentration", "concentration_diff", "min_datetime", "max_datetime",
  "sum_bobler", "n_bobler", "n_bubbles", "pumpcycle_duration_hr",
  "sum_bubbles_concentration", "datetime_bubbles"
))
