    ...
    data <- reactive({
      ...
      if(input$file_type == "DIY"){
        ...
        df <- read_csv(input$file$datapath,
                       col_names = c("millis", "stampunix", "datetime",
                                     "RH", "tempC", "CH4smV", "CH4rmV",
                                     "VbatmV", "K33_RH", "K33_Temp", "K33_CO2",
                                     "SampleNumber", "PumpCycle"),
                       col_types = cols(millis = col_integer(),
                                        stampunix = col_integer(),
                                        ...
                                        K33_Temp = col_double(),
                                        K33_CO2 = col_double(),
                                        SampleNumber = col_integer(),
                                        PumpCycle = col_integer())) %>%
